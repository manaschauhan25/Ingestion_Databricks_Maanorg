...
# MAGIC if not any(mount.mountPoint == mountPoint for mount in dbutils.fs.mounts()):
# MAGIC     dbutils.fs.mount(
# MAGIC         source = dbutils.secrets.get(scope="maanorg_kysecret", key="martcontainerpath"),
# MAGIC         mount_point= mountPoint,
# MAGIC         extra_configs= configs
# MAGIC     )
...
dbutils.fs.ls("/mnt/mart_datalake/")

# COMMAND ----------

dbutils.fs.unmount("/mnt/mount_datalake/")
