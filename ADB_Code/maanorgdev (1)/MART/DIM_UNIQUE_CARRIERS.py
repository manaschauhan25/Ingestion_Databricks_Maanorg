...
# MAGIC %sql
# MAGIC DESC cleansed_maanorg.UNIQUE_CARRIERS
...
create_mart_table('cleansed_maanorg','UNIQUE_CARRIERS','/mnt/mart_datalake/UNIQUE_CARRIERS','datalake_mart','UNIQUE_CARRIERS',None)

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from datalake_mart.UNIQUE_CARRIERS
...
insert_into_table('cleansed_maanorg','UNIQUE_CARRIERS','datalake_mart','UNIQUE_CARRIERS',None)
