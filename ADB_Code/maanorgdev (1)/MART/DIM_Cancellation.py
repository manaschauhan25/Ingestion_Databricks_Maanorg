...
# MAGIC %sql
# MAGIC DESC cleansed_maanorg.cancellation
...
create_mart_table('cleansed_maanorg','cancellation','/mnt/mart_datalake/DIM_Cancellation','datalake_mart','DIM_Cancellation',None)

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from datalake_mart.DIM_Cancellation
...
insert_into_table('cleansed_maanorg','cancellation','datalake_mart','DIM_Cancellation',None)
