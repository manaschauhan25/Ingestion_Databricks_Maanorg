...
# MAGIC %sql
# MAGIC SELECT *  FROM cleansed_maanorg.airport

# COMMAND ----------

# MAGIC %sql
# MAGIC DESC cleansed_maanorg.airport
...
create_mart_table('cleansed_maanorg','airport','/mnt/mart_datalake/DIM_Airport','datalake_mart','DIM_Airport',None)

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from datalake_mart.DIM_Airport
...
insert_into_table('cleansed_maanorg','airport','datalake_mart','DIM_Airport',None)
